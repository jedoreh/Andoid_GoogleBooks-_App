...
public class ApiUtil {
    ...
    public static ArrayList<Book> getBooksFromJson(String json) throws JSONException {
        final String ID = "id";
        ...
        try {
            ...
            for (int i = 0; i < numberOfBooks; i++) {
                ...
                int authorNum = 0;
                if (checkAuthor) {
                    int checkAuthorNum = volumeInfoJSON.getJSONArray(AUTHORS).length();
                    authorNum = checkAuthorNum;
                }
